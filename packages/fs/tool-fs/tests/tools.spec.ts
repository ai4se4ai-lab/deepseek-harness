...
const originalGuidance = {
  read: 'Use the read tool — not shell commands like cat — to inspect text files. Results include line numbers. Use offset and limit to continue reading large files. A PDF is read as its extracted text layer; a scanned or image-only PDF has no text to return.',
