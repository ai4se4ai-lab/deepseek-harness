...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  // MINDPORTALIX-TENANT-ISOLATION
  z.object({ code: z.literal('tenant-path-invalid'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('tenant-required'), message: z.string(), details: z.object({}) }),
