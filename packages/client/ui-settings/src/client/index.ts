...
export function apply(ctx: Context): void {
  ...
  // MINDPORTALIX-TENANT-ISOLATION: settingsAvailable, not isLoopback — see
  // `ConnectionHandle.settingsAvailable` and `RemoteHostFacts.settingsAvailable`.
  const persistence = ctx.remote.$host.settingsAvailable ? 'host' : 'memory'
