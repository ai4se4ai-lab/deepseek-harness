...
Five tool schemas enter the catalogue. The tools read and write the tenant's `knowledge/` bundle; the prompt guidance that tells the model *when* to use them is `@mindportalix/dsh-okf-context`.
